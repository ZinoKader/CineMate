...
/**
 * Cell view for season treeviews (creates both season and episode cells)
 */
...
public class SeasonTreeViewCell extends TreeCell<SeriesDetail> {
    ...
    protected void updateItem(SeriesDetail seriesItem, boolean empty) {
        ...
        if(seriesItem.getType().equals(TvType.SEASON)) {
        ...
        else if(seriesItem.getType().equals(TvType.EPISODE)) {
